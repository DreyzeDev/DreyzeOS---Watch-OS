...
**DreyzeOS image architecture**: AArch64 build target; exact Watch4,2 / 21U580 kernelcache architecture is **CONFIRMED ARM64E/AArch64**. This does not establish a DreyzeOS loader contract or runtime mapping.
...
For exact field-level metadata sources and the digest-verified target-kernel
