...
| EV-000A | Target metadata consistency | BLOCKED / PARTIAL | Sanitized IPS supports Watch4,2, watchOS 10.6.1, build 21U580, and T8006-consistent markers; board and DreyzeOS-relevant architecture are not established by that report | Independently sourced matching model/SoC/version/build and applicable board/architecture; no model-to-board inference | Target metadata facts in provenance envelope | `target_metadata_provenance` | YES | All currently required applicable metadata facts match and are proven |
